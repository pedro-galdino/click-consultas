...
class ServicoAgendaTest {
	...
	void criarAgenda() throws DadosInsuficientesException {
		Agenda agenda = new Agenda(
	            "Cardiologia",  // especialidadeMedica
	...
	@Test
	@Transactional
	void buscarPorIdExistente() throws AgendaInexistenteException{
		Agenda agenda = new Agenda();
	...
	@Test
	@Transactional
	void buscarPorIdInexistente() throws AgendaInexistenteException{
		long inexistente = 2L;
		
		assertThrows(AgendaInexistenteException.class, () -> servicoAgenda.buscarPorId(inexistente));
	}
	
	@Test
	@Transactional
	void removerExistente() throws AgendaInexistenteException {
		Agenda agenda = new Agenda();
		colecaoAgenda.save(agenda);
	...
	@Test
	@Transactional
	void removerInexistente() throws AgendaInexistenteException {
		long inexistente = 2L;
		assertThrows(AgendaInexistenteException.class, () -> servicoAgenda.remover(inexistente) );
	}
